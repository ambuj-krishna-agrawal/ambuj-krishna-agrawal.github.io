...
function work_4() {
	return {
        ...
        internship_date: "",
        internship_description: "Built a full-catalog audio retrieval system for style/emotion transfer in synthetic dubbing. Fine-tuned wav2vec2-2B with contrastive loss for multilingual embeddings and created automated evaluation suites, achieving ~13% improvement in human preference evaluations.",
		keywords: [
			"Netflix",
			"Machine Learning",
			"TTS",
